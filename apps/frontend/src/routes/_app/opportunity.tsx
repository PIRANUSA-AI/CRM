 ...
 * band of the Pipeline — a deal at or above the team's threshold — so there is
 * nothing left here to show and nothing to type in.
 *
...
export const Route = createFileRoute('/_app/opportunity')({
	beforeLoad: () => {
		throw redirect({ to: '/pipeline', search: { bucket: 'opportunity' } })
	},
})
